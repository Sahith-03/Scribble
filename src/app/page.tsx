...
const Home: React.FC = () => {
  ...
  return (
    ...
    <div ref={divRef} className="flex flex-col items-center ">
      ...
      <toolbarContext.Provider value={{stylusColor, setStylusColor, lineWidth, setLineWidth, tool, selectTool, font, setFont, fill, setFill,clearCanvas,downloadImage,setFontSize,undo,redo}}>
      <Toolbar
      ...
      setPolygonStack={setPolygonStack}
